  ...
  const handleClosePopup = () => {
    ...
    return(
            ...
            <div className="container-fluid py-lg-5 py-md-0 py-0 px-lg-5 px-md-0 px-0" >
                ...
                <div className='d-lg-flex d-md-inline d-inline'>
                    ...
                    <div className=' d-lg-inline d-flex justify-content-center align-items-center'>
                        <button onClick={handleReadMore}  className='read-button b-lg-0 mb-2 w-lg-25 w-50 px-lg-2 px-1 py-lg-2 py-1'><span className='px-lg-3 px-2 fs-6 '>Read More</span><FaArrowRight /></button>
                    </div>
                    </div>
                    <div className='col-lg-8 col-md-8 col-12 '> <img src={props.img} alt="placeholder" className="img-fluid h-lg-100 px-lg-5 px-0 py-lg-5 py-0" /></div>
                </div>
        ...
        <div className="popup-container">
          ...
          <div className='close-icon'  onClick={handleClosePopup}><MdClose/></div>
            <div className='mt-3 px-4'>
...
export default function allPCards(val, index, data){
